...
while True:
    ...
    while True:
        ...
        arr[0 : int(MyPipe.hgt * -1) - 40, int(MyPipe.dist) : int(MyPipe.dist) + 50] = [0, 128, 0]
        arr[int(MyPipe.hgt * -1) + 40 : -1, int(MyPipe.dist) : int(MyPipe.dist) + 50] = [0, 128, 0]

        arr[int(MyBird.hgt * -1) : int(MyBird.hgt * -1) + 25, 50 : 100] = [255, 255, 255]
